...
const Footer = () => {
  return (
    <footer className="max-h-10 py-1 rounded flex justify-between border-red-400 border-t-4 my-auto">
      ...
      <span className="text-teal-100 font-extralight text-xs italic hidden md:inline"> background image by <a href="https://unsplash.com/photos/p0j-mE6mGo4">lorenzo herrero from unsplash.</a></span></p>
